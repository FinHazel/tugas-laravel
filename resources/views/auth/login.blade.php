		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">Silahkan Masuk</h2>
				</div>
			</div>
			<div class="row justify-content-center">
				<div class="col-md-12 col-lg-10">
					<div class="wrap d-md-flex">
						<div class="img" style="background-image: url(images/bisucits.png);">
			      </div>
		          ...
		          <p class="text-center">Not a member? <a class="nav-link" href="{{ route('register')}}">{{ __('Sign Up') }}</a></p>
				  @endif
		        </div>
		      </div>
				</div>
