    ...
    <div class="products">
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                <div class="d-flex justify-content-between p-3 bg-white mb-3 align-items-center"> <span class="font-weight-bold text-uppercase">Product Samsung</span>
            </div>
        ...
        <div class="row g-3">
            ...
            <div class="col-md-4">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between"> <span class="font-weight-bold">{{ $fs->type }}</span> <span class="font-weight-bold">{{ $fs->harga }}</span>
                    </div>
                    <p class="cad-ext mb-1 mt-1">{{ $fs->spesifikasi }}</p>
